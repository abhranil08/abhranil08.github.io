...
const skills = {
  data: [
    ...
    },*/
    {
      ...
      skills: [
        "⚡ Building responsive and efficient backend applications using Java",
...
const awardsAndAchivements = {
  awardsAndAchivements: [
    ...
    },
    {
      ...
      duration: "2016 - 2020",
      descriptions: [
        "⚡ National level athlete - Represented West Bengal School team in the School National organized by ASISC twice, held in Odisha (2011) and Kerala (2013), as well as being named Best Athlete in the West Bengal School Regional Sports Meet twice.",
        ],
      website_link: "http://www.jaduniv.edu.in/",
    },
  ],
